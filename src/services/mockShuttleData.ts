...
export const ROUTES: Record<string, Route> = {
  A: { id: "A", name: "Commercial Area - KSB", color: "#E53E3E" },   // Red
  B: { id: "B", name: "Brunei - KSB", color: "#3182CE" },            // Blue
  C: { id: "C", name: "Pharmacy - Wilkado", color: "#ECC94B" },      // Yellow
  D: { id: "D", name: "Pharmacy - Medical Village", color: "#38A169" }, // Green
};
