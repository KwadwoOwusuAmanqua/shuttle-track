...
function crowdColor(count: number): string {
  if (count <= 8) return Colors.primary;       // low — cyan
  if (count <= 16) return Colors.secondary;    // moderate — amber
  return "#ef4444";                             // busy — red
}
...
function Divider() {
  return (
    <div style={{ height: 1, backgroundColor: Colors.surface_container_high, margin: "10px 0" }} />
  );
}
