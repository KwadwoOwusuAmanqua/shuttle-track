      ...
      <header className="topbar">
        <div className="brand">
          <span className="brandIcon">
            <Navigation size={16} strokeWidth={2.5} color={Colors[50]} />
          </span>
          ...
          <div className="sheetRouteList">
            {Object.values(ROUTES).map((route) => (
              ...
              >
                ...
                <ChevronRight size={16} strokeWidth={2} color={Colors[300]} />
              </button>
            ))}
          </div>
        )}
                ...
                <div key={stop.id} className="sheetStopRow">
                  ...
                  {eta !== null ? (
                    <span
                      ...
                      style={{
                        background: eta <= 3 ? Colors[100] : eta <= 8 ? Colors[100] : Colors[100],
                        color: eta <= 3 ? Colors[500] : eta <= 8 ? Colors[400] : Colors[300],
                      }}
                    >
                      {eta} min
                    </span>
